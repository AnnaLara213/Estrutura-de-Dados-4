...
void listarProdutosPorFabricante() {
    ...
    for (i = 0; i < numProdutos; i++) {
        if (strcmp(produtos[i].fabricante.codigo, codigoFabricante) == 0) {
            encontrou = 1;
            break;
        }
    }
